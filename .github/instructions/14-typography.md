...
Global typography utilities are defined in [app/globals.css](app/globals.css) under `@layer components` (e.g., `.typography-h1`, `.typography-p`, `.typography-muted`).

Use the helper components exported from [components/typography.tsx](components/typography.tsx) for quick demos and standard rendering.
